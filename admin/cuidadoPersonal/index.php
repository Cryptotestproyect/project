<?php 
include("../bd.php");
$sentencia=$conexion->prepare("SELECT * FROM productos_tienda where categoria='cuidado-personal' ");
$sentencia->execute();
...
if(isset($_POST['busqueda'])){
    ...
    $sentencia=$conexion->prepare("SELECT * FROM productos_tienda where nombre like '%$busqueda%' and categoria='cuidado-personal' ");
    $sentencia->execute();
    $lista_productos_tienda=$sentencia->fetchAll(PDO::FETCH_ASSOC);
}
...
-->
        ...
        <script type="text/javascript">
            function status_update (value,id) {
                //alert(id);
                let url="http://localhost/servi/admin/cuidadoPersonal/index.php";
