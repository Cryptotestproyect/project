<?php 
include("../bd.php");
$sentencia=$conexion->prepare("SELECT * FROM productos_tienda where categoria='material-medico' ");
$sentencia->execute();
...
if(isset($_POST['busqueda'])){
    ...
    $sentencia=$conexion->prepare("SELECT * FROM productos_tienda where nombre like '%$busqueda%' and categoria='material-medico' ");
    $sentencia->execute();
    $lista_productos_tienda=$sentencia->fetchAll(PDO::FETCH_ASSOC);
}
...
-->
        ...
        <script type="text/javascript">
            function status_update (value,id) {
                //alert(id);
                let url="http://localhost/servi/admin/materialMedico/index.php";
                window.location.href= url +"?id="+id+ "&status="+value;
            }
            function category_update (value,txtID) {
                //alert(id);
                let url="http://localhost/servi/admin/materialMedico/editar.php";
