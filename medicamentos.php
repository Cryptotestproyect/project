<?php
    include("admin/bd.php");
        ...
        $sentencia=$conexion->prepare("SELECT * FROM productos_tienda where categoria='medicamentos' and (status='on' or status='offer') ");
        $sentencia->execute();
        ...
        if(isset($_POST['busqueda'])){
            ...
            $sentencia=$conexion->prepare("SELECT * FROM productos_tienda where nombre like '%$busqueda%' and categoria='medicamentos' and  (status='offer' or status='on')  ");
            $sentencia->execute();
            $lista_productos_tienda=$sentencia->fetchAll(PDO::FETCH_ASSOC);
        }
